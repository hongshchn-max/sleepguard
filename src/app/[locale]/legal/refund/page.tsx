    ...
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <div className="space-y-6 text-gray-300 leading-relaxed">
        <section>
          ...
          <p>We offer a <strong>30-day money-back guarantee</strong> on all premium purchases. If you are not satisfied with SleepGuard Premium for any reason, you can request a full refund within 30 days of purchase.</p>
        </section>

        <section>
          <h2 className="mb-2 text-xl font-semibold text-white">How to Request a Refund</h2>
          <p>Send an email to <a href="mailto:koh923@icloud.com" className="text-luna-purple hover:underline">koh923@icloud.com</a> with:</p>
